...
def curated_ability_for_tool(tool_name: str, *, agent_name: str, intent: str, permissions: Iterable[str] = ()) -> AbilityRecord:
    ...
    curated: dict[str, dict[str, Any]] = {
        ...
        "app_closer": {
            ...
            "risk_level": "safe",
            "triggers": ["close", "quit", "exit", "close out", "close app", "close window", "shut down app", "can you close", "could you close"],
        ...
        "memory_store": {
            "display_name": "Save Long-Term Memory",
            "description": "Save explicit durable facts, preferences, and project instructions when the user asks Jarvis to remember them.",
            "risk_level": "safe",
            "triggers": ["remember", "remember that", "save this", "store this", "make a note", "note that"],
            "examples": ["Jarvis, remember that I like concise patch steps", "Jarvis, save this preference"],
            "permissions": ["memory_write"],
        },
        "memory_search": {
            "display_name": "Search Long-Term Memory",
            "description": "Search saved long-term memories for relevant user/project context.",
            "risk_level": "read_only",
            "triggers": ["what do you remember", "search memory", "search memories", "what memories", "remember about"],
            "examples": ["Jarvis, what do you remember about my music?"],
            "permissions": ["memory_read"],
        },
        "memory_list": {
            "display_name": "List Long-Term Memory",
            "description": "List saved long-term memories so the user can review what Jarvis knows.",
            "risk_level": "read_only",
            "triggers": ["list memories", "show memories", "what do you remember", "what app aliases do you remember"],
            "examples": ["Jarvis, list memories"],
            "permissions": ["memory_read"],
        },
        "memory_forget": {
            "display_name": "Forget Long-Term Memory",
            "description": "Remove matching saved memories when the user asks Jarvis to forget something.",
            "risk_level": "safe",
            "triggers": ["forget", "forget that", "forget memory", "remove memory", "delete memory", "stop remembering"],
            "examples": ["Jarvis, forget that my favorite color is blue"],
            "permissions": ["memory_write"],
        },
        "memory_status": {
            "display_name": "Memory Status",
            "description": "Report short-term and long-term memory status.",
            "risk_level": "read_only",
            "triggers": ["memory status", "long term memory status", "long-term memory status"],
            "examples": ["Jarvis, memory status"],
            "permissions": ["memory_read"],
        },
        "weather_lookup": {

...
KNOWN_APP_COMMANDS: dict[str, dict[str, list[str] | str]] = {
    ...
    "snipping tool": {"windows": ["cmd", "/c", "start", "", "snippingtool"], "default": ["gnome-screenshot"]},
    "snip": {"windows": ["cmd", "/c", "start", "", "snippingtool"], "default": ["gnome-screenshot"]},
    "screen snip": {"windows": ["cmd", "/c", "start", "", "ms-screenclip:"], "default": ["gnome-screenshot"]},
}
...
def normalize_app_name(value: str) -> str:
    ...
    aliases = {
        ...
        "screen clipping tool": "snipping tool",
    }

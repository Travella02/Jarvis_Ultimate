...
> Current milestone: **0.3.3a — Typed Input Stabilization + Natural Memory Search**  
> Next planned milestone: **0.3.4 — Relationship Memory Graph / Memory Preferences**
...
- typed app-shell commands now use the same spoken response path as voice commands,
- typed input does not require a wake word, because it is intentional input,
- app-shell typed responses are spoken aloud through TTS when available,
- typed responses update the live orb caption and voice session snapshot,
- running sleep/wake voice sessions are preserved after typed commands,
- desktop typed commands also use spoken response playback.

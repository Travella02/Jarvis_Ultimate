...
class Agent:
    ...
    def _relationship_display_label(self, relation: str) -> str:
        cleaned = " ".join(str(relation or "relationship").strip().lower().split())
        aliases = {"fiance": "fiancée", "fiancee": "fiancée", "pets": "pet", "dogs": "dog", "cats": "cat"}
